        ...
        <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className={`relative aspect-square overflow-hidden rounded-lg shadow-lg ${isOutOfStock ? "opacity-50" : ""}`}>
                    ...
                    {isOutOfStock && (
                        <div className="absolute insert-0 flex items-center justify-center bg-black bg-opacity-50">
                ...
                <div className="flex flex-col justify-between">
                    <div>
                        ...
                        <div className="text-xl     font-semibold mb-4">{product.price?.toFixed(2)}
                        </div>
