...
// Source: ./sanity/lib/products/getAllProduct.ts
...
// Source: ./sanity/lib/products/getAllProductByName.ts
...
// Query: *[        _type == "product" && slug.current == $sulg        ] | order(name asc) [0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[\n        _type == \"product\" && slug.current == $sulg\n        ] | order(name asc) [0]\n    ": PRODUCT_BY_ID_QUERYResult;
